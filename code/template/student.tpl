...
<div class="wrapper">
	<div style="float: left; width: 380px; margin-left: 20px;">
		<h3 class="center"><a href="student.php#" class="link">Xem kết quả học tập của học sinh</a></h3>
		...
		<table class="table" style="width: 100%;">
			<tr>
				...
				<td>
					<div class="select">
						<select name="year" id="menu_year" style="width: 150px;">
			...
			<tr>
				...
				<td>
					<div class="select">
					<select name="class" id="menu_class" style="width: 110px;">
	...
	<div style="float: right; width: 500px; margin-right: 20px;">
		...
		<table class="table center" style="width: 100%;">
			<tr>
				<td style="width: 45px;"><b>STT</b></td>
				<td style="width: 95px;"><b>Số báo danh:</b></td>
				<td style="width: 270px;"><b>Tên học sinh:</b></td>
				<td style="width: 55px;"><b>Lớp:</b></td>
			</tr>
			<!-- BEGIN: hs -->
			<tr>
				<td><b>{stt}</b></td>
		...
		<table class="table" style="width: 100%;">
			...
			<tr>
				...
				<td style="width: 430px;"><a href="xemdiem.php?db_id={db_id}&hsname={sbd}&search_method=sbd" target="_blank" class="link">{db_info}</a></td>
